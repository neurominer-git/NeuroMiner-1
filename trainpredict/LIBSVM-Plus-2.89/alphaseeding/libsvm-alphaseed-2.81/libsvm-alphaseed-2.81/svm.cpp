...
void Solver::Solve(int l, const QMatrix& Q, const double *b_, const schar *y_,
		   double *alpha_, double Cp_, double Cn_, double eps,
		   SolutionInfo* si, int shrinking)
{
	this->l = l;
	this->Q = &Q;
	...
	this->Cp = min(Cp_ / 1024.0, 1.0);
	this->Cn = Cn_ * this->Cp / Cp_;
	this->eps = eps;
	unshrinked = false;
