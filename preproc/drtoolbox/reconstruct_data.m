function recX = reconstruct_data(mappedX, mapping, ind)
...
% (C) Laurens van der Maaten, Delft University of Technology
    ...
    switch mapping.name
        ...
        case {'PCA', 'LDA', 'LPP', 'NPE', 'LLTSA', 'SPCA', 'PPCA', 'FA', 'NCA', 'MCML', 'LMNN'}
            if ~exist('ind','var') || isempty(ind), ind = 1:size(mapping.M,2); end
            recX = bsxfun(@plus, mappedX * mapping.M(:,ind)', mapping.mean);
