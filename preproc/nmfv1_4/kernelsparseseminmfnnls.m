...
% Definition:
%     [AtA,Y,numIter,tElapsed,finalResidual]=kernelsparseseminmfnnls(X,k)
%     [AtA,Y,numIter,tElapsed,finalResidual]=kernelsparseseminmfnnls(X,k,option)
...
% option.lambda: the sparisity parameter, the default is 0.1.
